...
const Faq: FunctionComponent = () => {
  return (
    <div className="absolute top-[0rem] left-[0rem] bg-gray-400 w-[94.5rem] h-[318.375rem] overflow-hidden text-left text-[1.25rem] text-white font-zcool-kuaile">
      ...
      />
      <div className="absolute top-[3.5rem] left-[12.375rem] text-[2rem] text-center">
        Saviour
      </div>
      <div className="absolute top-[2.875rem] left-[calc(50%_-_258px)] rounded-xl bg-gray-100 w-[36.438rem] flex flex-row items-start justify-start py-[1rem] px-[1.5rem] box-border gap-[0rem_1.5rem] text-center">
